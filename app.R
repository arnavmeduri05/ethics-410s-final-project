        ...
        fluidRow(
          column(width = 12,
                 ...
                 tags$p(style = "color:#444; font-size: 15px; margin: 0 0 6px 0;",
                        HTML("For use in the dashboard, the Crowd Counting Consortium dataset was filtered based on two rules: (1) events the source coders had tagged with <em>policing</em> were kept; and (2) events the source coders had tagged with <em>racism</em> were kept only if the event's title or claims summary also explicitly mentioned race or policing language (e.g., Black Lives Matter, police brutality, white supremacy, civil rights, immigration enforcement). Events whose left-versus-right valence (the source coders' indicator of whether an event leans politically left or right) was missing or neutral were also dropped, so left-leaning and right-leaning mobilization could be compared directly."))
          )
        ),
        fluidRow(
